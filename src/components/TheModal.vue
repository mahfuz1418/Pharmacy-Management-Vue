<template>
  <teleport to="body">
    <transition name="fade">
      <div class="the-modal" v-show="modalValue">
        <transition name="zoom">
          <div class="the-modal__container" v-show="modalValue">
            <div class="the-modal__header d-flex justify-content-between">
              <div class="p-2 pl-3">{{ heading }}</div>
